  ...
  function Person(props) {
    return React.createElement(
      ...
      React.createElement(
        "p",
        null,
        React.createElement("img", { className: " size-medium wp-image-14 alignright", src: props.person.img, alt: props.person.name, width: "300", height: "300", sizes: "(max-width: 300px) 100vw, 300px" }),
        props.person.bio
      )
    );
  }
